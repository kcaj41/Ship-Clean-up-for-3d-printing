...
class ShipCleanupProps(bpy.types.PropertyGroup):
    ...
    gear_exclude_regex: bpy.props.StringProperty(
        name="Gear exclusion regex", default=r"door",
        description="A gear-regex match is VETOED when the name also "
                    "matches this. LG bay doors (Front_LG_Door_Left) are "
                    "exterior hull that must print, but they matched "
                    "'(^|_)lg_' on the Avenger Titan")
